  ...
  return (
    <div className="glass p-6 rounded-2xl break-inside-avoid mb-6 relative group overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-slate-300 italic mb-6 leading-relaxed">"{recommendation.feedback}"</p>
        
        <div className="flex items-center gap-4">
          {(!recommendation.avatarUrl || imageError) ? (
            <div className="w-12 h-12 rounded-full border border-white/10 bg-brand/20 flex items-center justify-center text-brand-light font-display font-semibold">
          ...
          <div>
            <h4 className="font-display font-semibold text-white">{recommendation.name}</h4>
