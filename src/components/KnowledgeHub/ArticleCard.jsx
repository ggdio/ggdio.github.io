...
export function ArticleCard({ article }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col overflow-hidden transition-colors rounded-2xl glass hover:bg-white/5 border-gradient"
    >
      ...
      <div className="flex flex-col flex-grow p-6">
        ...
        <h3 className="mb-2 text-xl font-bold leading-tight text-white font-display line-clamp-2">
          {article.title}
        </h3>
